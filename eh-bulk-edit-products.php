...
else
{
    ...
    if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
        ...
        class Eh_Bulk_Edit_Main
        {
            ...
            {
                include_once('includes/class-eh-product.php');
            }
            public function eh_bep_action_link($links)
            {
                $plugin_links = array(
                    ...
                    '<a href="http://www.xadapter.com/support/forum/bulk-edit-products-prices-attributes-for-woocommerce/" target="_blank">' . __( 'Support', 'eh-woocommerce-pricing-discount' ) . '</a>'
                );
